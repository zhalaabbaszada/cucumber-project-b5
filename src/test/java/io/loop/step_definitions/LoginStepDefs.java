...
public class LoginStepDefs {
    ...
    public void user_enters_credentials(Map<String,String> credential) throws InterruptedException {
...
//        }
        ...
        loginPage.login(credential.get("username"), credential.get("password"));
    }
}
